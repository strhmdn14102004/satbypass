...
class BypassAppleWatchPage extends StatefulWidget {
  const BypassAppleWatchPage({super.key});

  @override
  BypassAppleWatchPageState createState() => BypassAppleWatchPageState();
}

class BypassAppleWatchPageState extends State<BypassAppleWatchPage> {
  bool loading = false;
      ...
      listener: (context, state) {
        if (state is BypassLoadLoading) {
          ...
          bypassList = state.bypassList
              .where((item) => item.name.contains("Bypass Apple Watch"))
              .toList();
          setState(() {});
                      ...
                      children: [
                        ...
                        Expanded(
                          child: Column(
                            ...
                            children: [
                              Text(
                                Formats.spell("Bypass Apple Watch".tr()),
                                style: TextStyle(
                                  color: AppColors.surface(),
