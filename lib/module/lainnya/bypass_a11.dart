...
class BypassA11Page extends StatefulWidget {
  const BypassA11Page({super.key});

  @override
  BypassA11PageState createState() => BypassA11PageState();
}

class BypassA11PageState extends State<BypassA11Page> {
  bool loading = false;
    ...
    return BlocListener<BypassBloc, BypassState>(
      listener: (context, state) {
        if (state is BypassLoadLoading) {
          ...
          // Filter hanya item yang mengandung "Bypass (A11)" di nama
          bypassList = state.bypassList
              .where((item) => item.name.contains("Bypass (A11)"))
              .toList();
          setState(() {});
                      ...
                      children: [
                        ...
                        Expanded(
                          child: Column(
                            ...
                            children: [
                              Text(
                                Formats.spell("Bypass A11 Series".tr()),
                                style: TextStyle(
                                  color: AppColors.surface(),
