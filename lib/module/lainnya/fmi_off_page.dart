...
class FmiOffPage extends StatefulWidget {
  const FmiOffPage({super.key});

  @override
  FmiOffPageState createState() => FmiOffPageState();
}

class FmiOffPageState extends State<FmiOffPage> {
  bool loading = false;
      ...
      listener: (context, state) {
        if (state is BypassLoadLoading) {
          ...
          bypassList = state.bypassList
              .where((item) => item.name.contains("FMI"))
              .toList();
          setState(() {});
