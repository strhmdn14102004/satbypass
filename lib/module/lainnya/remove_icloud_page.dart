...
class RemoveIcloudPage extends StatefulWidget {
  const RemoveIcloudPage({super.key});

  @override
  RemoveIcloudPageState createState() => RemoveIcloudPageState();
}

class RemoveIcloudPageState extends State<RemoveIcloudPage> {
  bool loading = false;
      ...
      listener: (context, state) {
        if (state is BypassLoadLoading) {
          ...
          bypassList = state.bypassList
              .where((item) => item.name.contains("Case Remove"))
              .toList();
          setState(() {});
                      ...
                      children: [
                        ...
                        Expanded(
                          child: Column(
                            ...
                            children: [
                              Text(
                                Formats.spell("REMOVE_ICLOUD".tr()),
                                style: TextStyle(
                                  color: AppColors.surface(),
