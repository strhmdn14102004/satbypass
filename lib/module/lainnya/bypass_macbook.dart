...
class BypassMacBookPage extends StatefulWidget {
  const BypassMacBookPage({super.key});

  @override
  BypassMacBookPageState createState() => BypassMacBookPageState();
}

class BypassMacBookPageState extends State<BypassMacBookPage> {
  bool loading = false;
      ...
      listener: (context, state) {
        if (state is BypassLoadLoading) {
          ...
          bypassList = state.bypassList
              .where((item) => item.name.contains("Bypass Macbook"))
              .toList();
          setState(() {});
                      ...
                      children: [
                        ...
                        Expanded(
                          child: Column(
                            ...
                            children: [
                              Text(
                                Formats.spell("Bypass MacBook".tr()),
                                style: TextStyle(
                                  color: AppColors.surface(),
