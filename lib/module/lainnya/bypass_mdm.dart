...
class BypassMDMPage extends StatefulWidget {
  const BypassMDMPage({super.key});

  @override
  BypassMDMPageState createState() => BypassMDMPageState();
}

class BypassMDMPageState extends State<BypassMDMPage> {
  bool loading = false;
      ...
      listener: (context, state) {
        if (state is BypassLoadLoading) {
          ...
          bypassList = state.bypassList
              .where((item) => item.name.contains("Bypass MDM"))
              .toList();
          setState(() {});
